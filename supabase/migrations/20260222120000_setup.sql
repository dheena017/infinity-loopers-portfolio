...
-- Updated to include email column and secretaries table
...
create policy "public read operatives" on operatives for select using (true);
create policy "public read missions" on missions for select using (true);
create policy "public read mission operatives" on mission_operatives for select using (true);
...
create policy "public read portfolio missions" on portfolio_missions for select using (true);
