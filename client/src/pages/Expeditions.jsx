                        ...
                        >
                            <div className="flex justify-between items-start">
                                <div className={`p-4 rounded-xl bg-slate-950 border border-white/5`}>
                                    <project.icon size={28} className="text-blue-500" />
                                </div>
                                <div className="flex gap-3">
                                    <button className="p-3 bg-slate-950 rounded-xl border border-white/5 hover:border-blue-500/50 transition-colors">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-4xl font-black heading-display text-white group-hover:text-blue-500 transition-colors">
                                    {project.title}
                                </h3>
                            ...
                            <div className="flex flex-wrap gap-2 mt-auto pt-8 border-t border-white/5">
                                {project.tags.map(tag => (
                                    <span key={tag} className="px-4 py-1.5 bg-slate-800 border border-white/5 rounded-lg text-[10px] font-bold text-slate-400 uppercase tracking-widest group-hover:border-blue-500/20 transition-colors">
                                        {tag}
                                    </span>
                                ))}
                            </div>
                            ...
                            <div className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-all group-hover:translate-x-1 group-hover:-translate-y-1">
                                <ArrowUpRight size={24} className="text-blue-500/40" />
                            </div>
                        </motion.div>
                    ))}
                </div>
